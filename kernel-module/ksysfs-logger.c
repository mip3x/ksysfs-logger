...
static ssize_t
filename_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count) {
    char temp[NAME_MAX];
...
static struct kobj_attribute filename_attr = __ATTR(filename, 0644, filename_show, filename_store);

// sysfs period param
static ssize_t period_ms_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf) {
...
static ssize_t
period_ms_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count) {
